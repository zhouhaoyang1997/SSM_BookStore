    ...
    <div class="login_main_mid">
        ...
        <form action="/login.do" method="post" onSubmit="return checkLogin()">
            <dl class="login_content">
                <dt>用户名：</dt>
                <dd><input name="userName" id="email" type="text" class="login_content_input" onFocus="emailFocus()" onBlur="emailBlur()"></dd>
                <dd style="color: red">${message}</dd>
            </dl>
            <dl class="login_content">
                <dt>密码：</dt>
                <dd><input name="userPass" id="pwd" type="password" class="login_content_input" onFocus="pwdFocus()" onBlur="pwdBlur()"></dd>
            </dl>
            <dl class="login_content">
                <dt></dt>
